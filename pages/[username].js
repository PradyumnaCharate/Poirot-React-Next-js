...
function ProfilePage({
  ...
  useEffect(() => {
    const getPosts = async () => {
      ...
      try {
        //This is next dynamic page so we have named it in square brackets 
        //username in file name will be replaced by actual user's name 
        //router.quuery will recieve username
