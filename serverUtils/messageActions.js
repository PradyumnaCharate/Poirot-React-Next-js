...
//this function load messages with requested user
...
const sendMsg = async (userId, msgSendToUserId, msg) => {
  try {
    ...
    //if there are chats present already with that user just push the object to array
    ...
    const previousChatForReceiver = msgSendToUser.chats.find(
      ...
      //also adding messages data  to recievers database
